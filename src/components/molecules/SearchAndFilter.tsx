      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full border border-theme rounded-md py-3 pl-12 pr-4 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-theme text-theme"
        ...
        <div className="relative">
          ...
          <select
            ...
            className="appearance-none border border-theme rounded-md py-3 pl-4 pr-10 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-theme text-theme min-w-[200px]"
