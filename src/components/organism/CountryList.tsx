...
const CountryList: React.FC<CountryListProps> = ({ countries }) => {
  ...
  const CountryRow = ({ country }: { country: Country }) => {
    const content = (
      <div className="grid grid-cols-6 gap-4 p-4 hover:bg-accent/10 transition-colors items-center">
        {/* Flag */}
    ...
    return <div key={country.cca2} className='border-b border-theme' >{content}</div>;
  };
